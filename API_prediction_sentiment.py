...
NLTK_DATA_PATH = (
    str(Path.home() / "nltk_data") if "CI" in os.environ
    else os.path.join(
        r'C:\Users\attia\P7_Réalisez_une_analyse_de_sentiments_grâce_au_Deep_Learning\environnement\myenv', 
        'nltk_data'
    )
)
...
def clean_text(text: str) -> str:
    """
    Nettoie le texte en supprimant ponctuation, chiffres et en convertissant en minuscule.
    """
    text = text.lower()
